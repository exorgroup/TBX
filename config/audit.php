...
return [
    ...
    */
    ...
    | This is the correct place for the user resolver and guards configuration.
    |
    */

    'user' => [
        'morph_prefix' => 'user',
        'resolver' => OwenIt\Auditing\Resolvers\UserResolver::class, // Use the default resolver
        'guards' => [
            // Config::get('auth.defaults.guard'), // Keep or remove as needed
            'web', // Keep or remove as needed
            'api', // Keep or remove as needed
            'backpack', // Add the backpack guard here
        ],
    ],
    ...
    | The user resolver is configured under the top-level 'user' key.
    |
    */
    'resolvers' => [
        ...
        // Remove the nested 'user' array from here
    ],
